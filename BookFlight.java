...
public class BookFlight extends JFrame implements ActionListener {
    ...
    public BookFlight() {
        ...
        setLayout(null); // by default it gives border layout
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == fetchButton) {
            ...
            try {
                Conn conn = new Conn();
                String query = "insert into reservation values('PNR-"+random.nextInt(1000000)+"', 'TIC-"+random.nextInt(10000)+"', '"+aadhar+"', '"+name+"', '"+nationality+"', '"+flightname+"', '"+flightcode+"', '"+src+"', '"+des+"')";
